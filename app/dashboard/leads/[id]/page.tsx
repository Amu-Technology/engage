...
import { FamilyMemberManager } from "./components/FamilyMemeberManager";
...
export default function LeadDetailPage() {
  ...
  const fetchActivities = useCallback(async () => {
    try {
      ...
      if (!response.ok)
        throw new Error(
          response.statusText + " " + response.json + "アクティビティエラー"
        );
    ...
    <div className="container mx-auto p-4 space-y-4">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle>
            リード情報:{lead.type == "individual" ? "個人" : "組織"}
          </CardTitle>
          <LeadForm
            lead={lead}
            onSuccess={fetchLeadData}
            type={lead.type as "individual" | "organization"}
          />
        </CardHeader>
        <CardContent>
      ...
      <FamilyMemberManager leadId={lead.id} />
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        {history.oldStatus ? (
                          <>
                            <div
                              ...
                              style={{
                                backgroundColor:
                                  history.oldStatus.color || "#808080",
                              }}
                            />
                        ...
                        <div
                          ...
                          style={{
                            backgroundColor:
                              history.newStatus.color || "#808080",
                          }}
                        />
